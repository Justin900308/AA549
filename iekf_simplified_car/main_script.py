"""Replicate the simplified-car EKF/LIEKF example from Barrau-Bonnabel TAC 2017.
...
if __name__ == "__main__":
    ...
    plot_simplified_car_cases(results, save_path=str(out_dir / "simplified_car_ekf_liekf_comparison.png"))
    plt.show()
